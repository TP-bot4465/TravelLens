...
![YOLOv11](https://img.shields.io/badge/AI-YOLOv11-blueviolet?style=flat-square)
![Gemini](https://img.shields.io/badge/GenAI-Google%20Gemini-4285F4?style=flat-square&logo=google&logoColor=white)
...
* **LLM & Search:**
    * ![Google Gemini](https://img.shields.io/badge/Google%20AI-Gemini%202.5%20Flash-4285F4?style=flat-square&logo=google&logoColor=white)
    * ![Tavily](https://img.shields.io/badge/Search-Tavily%20API-FF6C37?style=flat-square)

### Frontend

* **Giao diện:** ![HTML5](https://img.shields.io/badge/HTML5-E34F26?style=flat-square&logo=html5&logoColor=white) ![CSS3](https://img.shields.io/badge/CSS3-1572B6?style=flat-square&logo=css3&logoColor=white) (Responsive Design).
* **Logic:** ![JavaScript](https://img.shields.io/badge/JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black) (Vanilla JS xử lý Camera stream & AJAX).
...
```bash
git clone [https://github.com/your-username/TravelLens.git](https://github.com/your-username/TravelLens.git)
cd TravelLens
```
...
```env
# Lấy key miễn phí tại: [https://aistudio.google.com/](https://aistudio.google.com/)
GEMINI_API_KEY=your_gemini_api_key_here

# Lấy key miễn phí tại: [https://tavily.com/](https://tavily.com/)
